...
<body>
		...
		<div class="blocRecherche">
				...
				<p>
						...
						caractère '*' pour remplacer un ou plusieurs caractères (ex. :
				...
				<form action="recherche_joueur" method="post">
						...
						<span class="champRecherche">&nbsp;Nom</span> <input type="text"
								name="nom" /> <br /> <br /> <span class="champRecherche">&nbsp;Prenom</span>
						<input type="text" name="prenom" /> <br /> <br /> <span
								class="champRecherche">&nbsp;License</span> <input type="text"
								name="license" /> <br /> <br /> <span class="champRecherche">&nbsp;Sexe</span>
						<select name="sexe">
								<option value="">Tous</option>
								<option value="">Homme</option>
								<option value="">Femme</option>
						</select> <br /> <br /> <span class="champRecherche">&nbsp;Classement</span>
						...
						</select> <br /> <br /> <span class="champRecherche">&nbsp;Ligue</span> <select
								name="ligue">
								<option>Toutes</option>
								<c:forEach items="${ligues}" var="ligue">
										<option><c:out value="${ ligue }"></c:out></option>
								</c:forEach>
						</select> <br /> <br /> <span class="champRecherche">&nbsp;Ville</span> <input
								type="text" name="ville"> (ou code postal)<br /> <br />
						<span class="champRecherche">&nbsp;Sigle Club</span> <input
								type="text" name="sigleClub"> <br /> <br /> <span
								id="boutonSubmit"><input type="submit" value="Rechercher"
								name="rechercher"></span>
